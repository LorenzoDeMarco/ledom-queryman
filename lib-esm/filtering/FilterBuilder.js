...
import { AndFilter, OrFilter, XorFilter, NotFilter, EqFilter, NeqFilter, GtFilter, LtFilter, GteFilter, LteFilter } from './Filters';
export default function buildFilter(filter_obj) {
